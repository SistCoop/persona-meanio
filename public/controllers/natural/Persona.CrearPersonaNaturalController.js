...
/* jshint -W098 */
angular.module('mean.persona').controller('Persona.CrearPersonaNaturalController', function(
    $scope, $state, $stateParams, toastr, SGCountryCode, SGTipoDocumento, SGEstadoCivil, SGSexo, SGPersonaNatural) {
