...
angular.module('mean.pkpersona').service('$menuItemsPersona', [
    function() {
        ...
        this.prepareSidebarMenu = function()
        {
            ...
            productos.addItem('Naturales', 'pkpersona.app.personas.buscarPersonaNatural');
            productos.addItem('Juridicas', 'pkpersona.app.personas.buscarPersonaJuridica');
